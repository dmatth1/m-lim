# Task: Waveform Top Gradient — Warm Color Shift
...
The hex `242027` is (R=36, G=32, B=39) — a slightly cool purple-gray.
...
Pixel verification:
```bash
convert /tmp/mlim.png -crop 400x1+100+80 -scale 1x1! -format '%[hex:u]' info:

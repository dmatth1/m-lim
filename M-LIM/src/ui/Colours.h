...
namespace MLIMColours
{
    ...
    const juce::Colour barTrackBackground       { 0xff1C1820 };  // background track behind progress bars (dark purple-tinted, closer to ref #231E24)
    ...
    const juce::Colour displayGradientTop   { 0xff3A3540 };  // dark blue-gray, fine-tuned for wave RMSE (task-368)
    ...
    const juce::Colour knobFaceHighlight{ 0xffC0C0D0 };  // brighter blue-tinted highlight (matches reference metallic sheen ~#DBDBE7)

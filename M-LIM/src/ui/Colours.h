...
namespace MLIMColours
{
    ...
    const juce::Colour displayGradientTop   { 0xff201E24 };  // task-499: shift cool (R=32,G=30,B=36) to match reference upper zone (39,37,42)
    ...
    const juce::Colour waveformIdleLowFill  { 0xffA8A8B8 };  // task-522: lightened from 0xff9898A8 to close lower zone brightness gap
    ...
    const juce::Colour knobFaceShadow   { 0xff8F8F9B };  // lightened shadow to match reference ~(143,143,155) — knob centre ~(185,185,196)
    ...
    // Button colours
    const juce::Colour algoButtonInactive       { 0xff545463 };  // R=84 G=84 B=99 reduce blue to match reference (task-521)
